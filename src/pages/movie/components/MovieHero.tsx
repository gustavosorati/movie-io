...
import { Movie } from "@/components/old/Movie";
...
export function MovieHero({movie}: Props) {
  return (
    <div className="w-full flex flex-col items-center justify-center bg-gray-1 p-6 border-2 border-white/10 rounded-lg max-w-[1010px]">
      ...
      <div className="flex flex-col items-center justify-center">
        ...
        {/* Title Movie */}
        <h1 className="text-3xl font-bold mb-3">{movie.details.title}</h1>
